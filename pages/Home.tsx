...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-white dark:bg-dark-bg">
        {/* Subtle dot grid pattern */}
        <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMjAiIGhlaWdodD0iMjAiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PGNpcmNsZSBjeD0iMiIgY3k9IjIiIHI9IjIiIGZpbGw9IiNENEFGMzciIGZpbGwtb3BhY2l0eT0iMC4xIi8+PC9zdmc+')] opacity-50 z-0"></div>
        {/* Blurred Golden Glow */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-primary-500/10 rounded-full blur-[100px] pointer-events-none z-0"></div>
        <div className="absolute inset-0 w-full h-full bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-10 z-0 pointer-events-none"></div>
        ...
        <div className="container mx-auto px-4 z-10 relative">
          <div className="flex flex-col md:flex-row items-center justify-between gap-12">
            ...
            >
              <motion.div variants={fadeInUp} className="inline-block px-4 py-2 mb-4 rounded-full bg-white/50 dark:bg-white/5 backdrop-blur-sm border border-gray-200 dark:border-dark-border">
                <span className="text-primary-600 dark:text-primary-400 font-medium">👋 Hello, I'm Sandip Ganava</span>
              </motion.div>

              <motion.h1 variants={fadeInUp} className="text-4xl md:text-6xl font-extrabold tracking-tight text-gray-900 dark:text-white mb-6 leading-tight">
                I build fast, modern web & mobile applications that help businesses <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-secondary-600">grow.</span>
              </motion.h1>
              ...
              <motion.p variants={fadeInUp} className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto md:mx-0 leading-relaxed">
                Full-Stack Developer specializing in MERN Stack, React Native, and WordPress. Turning complex problems into elegant, scalable solutions.
              </motion.p>
              ...
              <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                ...
                <a href="./media/sandip__resume.pdf" className="px-8 py-4 bg-white dark:bg-dark-surface text-gray-900 dark:text-white border border-gray-200 dark:border-dark-border rounded-xl font-semibold hover:shadow-lg transition-all hover:scale-105 flex items-center justify-center gap-2">
            ...
            >
              <div className="relative w-80 h-80 md:w-96 md:h-96 mx-auto">
                ...
                <motion.div
                  className="absolute -top-4 -right-4 bg-white dark:bg-dark-surface p-4 rounded-xl shadow-xl z-20 flex items-center gap-2"
                  animate={{ y: [0, -10, 0] }}
                ...
                <motion.div
                  className="absolute bottom-10 -left-10 bg-white dark:bg-dark-surface p-3 rounded-xl shadow-xl z-20"
                  animate={{ y: [0, 10, 0] }}
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              >
                <div className="bg-primary-50 dark:bg-dark-bg p-3 rounded-full mb-3 text-primary-600">
                  <stat.icon size={24} />
                </div>
                <span className="text-3xl font-bold text-gray-900 dark:text-white mb-1">{stat.value}</span>
                <span className="text-sm text-gray-500 dark:text-gray-300 font-medium">{stat.label}</span>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      {/* <section className="py-10 bg-gray-50 dark:bg-dark-bg overflow-hidden">
        <div className="container mx-auto px-4 mb-6">
          <p className="text-center text-sm font-semibold text-gray-500 dark:text-gray-300 uppercase tracking-widest">Trusted By</p>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-end mb-12">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300 max-w-xl">A selection of my recent work in web and mobile development.</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {PROJECTS.slice(0, 3).map((project) => (
              <motion.div
                ...
                viewport={{ once: true }}
                whileHover={{ y: -5 }}
                className="bg-gray-50 dark:bg-dark-bg rounded-2xl overflow-hidden shadow-lg border border-gray-100 dark:border-dark-border"
              >
                <div className="h-48 overflow-hidden relative">
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent z-10"></div>
                  <img loading="lazy" src={project.image} alt={project.title} className="w-full h-full object-cover transition-transform duration-500 hover:scale-110" />
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-wrap gap-2 mb-6">
                    {project.techStack.slice(0, 3).map((tech) => (
                      <span key={tech} className="text-xs font-medium text-gray-500 bg-white dark:bg-dark-surface border border-gray-200 dark:border-dark-border px-2 py-1 rounded">
                        {tech}
                      </span>
                    ))}
                  </div>
      ...
      <section className="py-20 bg-gray-50 dark:bg-dark-bg">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">High-quality development services tailored to your business needs.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {SERVICES.slice(0, 4).map((service, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: index * 0.1 }}
                className="p-6 rounded-2xl bg-white dark:bg-dark-bg border border-gray-100 dark:border-dark-border hover:shadow-lg transition-shadow group"
              >
                <div className="w-12 h-12 bg-primary-50 dark:bg-dark-bg rounded-xl flex items-center justify-center text-primary-600 shadow-sm mb-6 group-hover:scale-110 transition-transform duration-300">
      ...
      <section className="py-20 bg-white dark:bg-dark-bg border-y border-gray-100 dark:border-dark-border">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">Client Testimonials</h2>
            <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">Don't just take my word for it. Here's what my clients have to say.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {TESTIMONIALS.map((testimonial, idx) => (
              <motion.div
                ...
                className="bg-gray-50 dark:bg-dark-bg p-8 rounded-2xl relative"
              >
                ...
                <div className="flex items-center gap-4">
                  <img loading="lazy" src={testimonial.avatar} alt={testimonial.name} className="w-12 h-12 rounded-full object-cover" />
                  <div>
                    <h4 className="font-bold text-gray-900 dark:text-white text-sm">{testimonial.name}</h4>
                    <p className="text-xs text-gray-500 dark:text-gray-300">{testimonial.role}, {testimonial.company}</p>
                  </div>
                </div>
              </motion.div>
            ))}
        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-end mb-12">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300 max-w-xl">Tips, tutorials, and updates from the world of web development.</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {BLOGS.slice(0, 3).map((blog) => (
              <Link to={`/blog/${blog.id}`} key={blog.id} className="group">
                <div className="bg-white dark:bg-dark-bg rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-all h-full flex flex-col">
      ...
      <section className="py-20 bg-white dark:bg-dark-bg">
        <div className="container mx-auto px-4 max-w-3xl">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 dark:text-gray-300">Everything you need to know about working with me.</p>
          </div>
          ...
          <div className="space-y-4">
            {FAQS.map((faq, index) => (
              <div
                key={index}
                className="border border-gray-200 dark:border-dark-border rounded-xl overflow-hidden bg-gray-50 dark:bg-dark-bg transition-colors"
              >
                <button
                ...
                <AnimatePresence>
                  {activeAccordion === index && (
                    ...
                    >
                      <div className="px-6 pb-6 text-gray-600 dark:text-gray-300 leading-relaxed border-t border-gray-200 dark:border-dark-border pt-4">
                        {faq.answer}
                      </div>
                    </motion.div>
                  )}
